        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PuissanceFiscal = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MiseCirculationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Genre = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Type = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ModeCarburant = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Acquisition = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    TH = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TJ = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnginId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Insurances_Engins_EnginId",
                        column: x => x.EnginId,
                        principalTable: "Engins",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Insurances_Engins_EnginId1",
                        column: x => x.EnginId1,
                        principalTable: "Engins",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Right_Roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Right_Roles_RoleId1",
                        column: x => x.RoleId1,
                        principalTable: "Roles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accounts_Right_RightId",
                        column: x => x.RightId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Insurances_EnginId",
                table: "Insurances",
                column: "EnginId");

            migrationBuilder.CreateIndex(
                name: "IX_Insurances_EnginId1",
                table: "Insurances",
                column: "EnginId1");
